...
/***** Pages ****/
const Dashboards = Loadable(lazy(() => import('../views/dashboards/dashboards')));


/***** Apps ****/
const UserList = Loadable(lazy(() => import('../views/apps/userList/userList')));
const DeviceList = Loadable(lazy(() => import('../views/apps/deviceList/deviceList')));
const CreateUserList= Loadable(lazy(() => import('../views/apps/userList/CreateUserList')));
...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      { path: '/dashboards', name: 'dashboards', exact: true, element: <Dashboards /> },
      { path: '/apps/userlist', name: 'userlist', exact: true, element: <UserList /> },
      { path: '/apps/createuserlist', name: 'createuserlist', exact: true, element: <CreateUserList /> },
      { path: '/apps/deviceList', name: 'deviceList', exact: true, element: <DeviceList /> },
